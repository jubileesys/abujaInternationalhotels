...
export default function NewsBanner() {
    return (
        ...
        <Link href="/investors/results" className="flex flex-col md:flex-row justify-between items-center py-8 group border-y   border-[#DC833D] hover:border-[#DC833D] transition-all duration-300">
