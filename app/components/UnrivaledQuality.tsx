...
export default function UnrivaledQuality() {
  return (
        ...
        <div className="relative z-20 w-full max-w-4xl mx-4 -mt-24 md:-mt-32">
          ...
          >
            ...
            <p className="max-w-xl mx-auto text-sm md:text-lg text-gray-300 font-sans leading-relaxed mb-8">
              With properties in prime locations and markets, we have an unmatched, geographically diverse portfolio of iconic and irreplaceable assets.
            </p>
